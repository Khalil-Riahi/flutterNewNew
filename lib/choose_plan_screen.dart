    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: isActive ? Color(0xFF3C5DF7) : Colors.transparent,
            borderRadius: BorderRadius.circular(12),
          ),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isSelected ? Color(0xFF3C5DF7) : Colors.grey.shade200,
            width: isSelected ? 2 : 1,
          ),
          boxShadow: isSelected
              ? [
                  BoxShadow(
                      color: Color(0xFF3C5DF7).withOpacity(0.15),
                      blurRadius: 10,
                      offset: Offset(0, 4))
                ]
              : [
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: isSelected ? Color(0xFF3C5DF7) : Colors.white,
                    border: Border.all(
                      color:
                          isSelected ? Color(0xFF3C5DF7) : Colors.grey.shade300,
                      width: 2,
                    ),
                  ),
                  child: isSelected
            ...
            ...features.map((feature) => Padding(
                  ...
                  child: Row(
                    children: [
                      Text("• ",
                          style: TextStyle(
                              fontSize: 16, color: Color(0xFF3C5DF7))),
                      Expanded(
